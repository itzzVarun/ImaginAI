...
import { generateImageAPI } from "../../apis/chatGPT/chatGPT";
...
const GenerateImage = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      console.log(values);
      mutation.mutate(
        `A realistic image of ${values.prompt}`
      );
      setGeneratedContent(`Generated image for prompt: ${values.prompt}`);
    },
  });
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-900 flex justify-center items-center p-6">
      <div className="bg-white rounded-xl shadow-xl overflow-hidden max-w-2xl w-full p-6">
        ...
        {/* Loading */}
        {mutation?.isPending && (
          <StatusMessage type="loading" message="Generating please wait..." />
        )}
        ...
        {mutation?.isSuccess && (
          <StatusMessage
            type="success"
            message="Image generation is successfull"
          />
        )}
        {/* error */}
        {mutation?.isError && (
        ...
        <form onSubmit={formik.handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            >
              Enter a prompt to unleash your imagination
            </label>
            <input
              id="prompt"
              type="text"
        ...
        {mutation.isSuccess && (
          <div className="mt-6 p-4 bg-gray-100 rounded-md">
            <h3 className="text-lg font-semibold text-gray-800 mb-2 flex justify-center items-center">
              Generated Image:
            </h3>
