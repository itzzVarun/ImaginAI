                  ...
                  <div className="slider-container">
                    <div className="slide flex mb-16 items-start">
                      ...
                      <div className="max-w-lg">
                        ...
                        <p className="text-xl text-gray-400">
                          ImaginAI revolutionizes the way of generating images.
                          Using advanced machine learning algorithms, our
                          platform generates high-quality, unique images in
                          seconds.
                        </p>
                      </div>
                    </div>
                    <div className="slide flex mb-16 items-start">
                      ...
                      <div className="max-w-lg">
                        ...
                        <p className="text-xl text-gray-400">
                          Whether it’s social media posts, illustrations for
                          your book or marketing materials. ImaginAI tailors
                          images to your specific needs, ensuring each image is
                    ...
                    <div className="slide flex items-start">
                      ...
                      <div className="max-w-lg">
                        ...
                        <p className="text-xl text-gray-400">
                          ...
                          ImaginAI becomes a natural extension of your workflow,
                          making image generation more efficient than ever
                          before.
                        </p>
                      </div>
                    </div>
